...
async def list_tables() -> Dict[str, List[str]]:
    ...
    return {"tables": table_names}  # Dict format instead of List[str] because cursor's (v2.4.31) agent was having issues with List return type and picking only the last table.
